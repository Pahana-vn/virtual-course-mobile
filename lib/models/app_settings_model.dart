...
class AppSettingsModel {
  ...
  final CategoryDTO? homeCategory1, homeCategory2, homeCategory3;
  ...
  factory AppSettingsModel.fromFirestore(DocumentSnapshot snap) {
    ...
    return AppSettingsModel(
      ...
      website: d['website'],
      homeCategory1: d['category1'] != null ? CategoryDTO.fromJson(d['category1']) : null, // ✅ Dùng CategoryDTO thay vì HomeCategory
      homeCategory2: d['category2'] != null ? CategoryDTO.fromJson(d['category2']) : null,
      homeCategory3: d['category3'] != null ? CategoryDTO.fromJson(d['category3']) : null,
